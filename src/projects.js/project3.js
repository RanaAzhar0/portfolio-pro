...
import pro1 from "../images/Screenshot (68).png"
        ...
        <div className="w-full bg-black pt-14 pb-14 flex justify-center items-center">
            <div className=' md:w-[88%] h-[100%] flex flex-wrap justify-center  md:flex md:justify-between'> 
                ...
                <div data-aos="zoom-in" className="spain1 flex flex-col justify-around mt-4 md:mt-0 w-[70%] md:w-[48%] text-white md:h-[90vh] p-7 rounded-3xl">
                    ...
                    <h1 className="text-gray-400 mt-2 md:mt-0">URL :<a className="text-blue-500 text-sm md:text-lg md:ml-5" href="https://ranaazhar0.github.io/Export-theme-/">https://ranaazhar0.github.io/Export-theme-/</a></h1>
                    <h1 className="text-gray-400 mt-2 md:mt-0">MY github :<a className="text-blue-500 md:text-lg md:ml-5" href="https://github.com/RanaAzhar0/Export-theme-.git">https://github.com/RanaAzhar0/Export-theme-.git </a></h1>
                </div>
            </div>
        </div>
